...
def main():
    ...
    if st.session_state.get('authentication_status'):
        ...
        if not filtered_sales.empty:
            ...
            with col1:
                render_stat_card("💰 Total Sales", format_number(total_sales), "#07f0f0")
        ...
        if not opp_df.empty:
            ...
            with col2:
                render_stat_card("📈 Total Opportunities", format_number(total_opp), "#02e382")

            with col3:
                render_stat_card("📊 Avg. Opportunity Size", format_number(avg_opp), "#e39c02")
        ...
        st.header("Forcasting Using LSTM Model (Only appear when click '📈 Get Forecast')")
